...
in {
  scripts.activate-virtualenv-python38 = {
    description = "Activate virtualenv for python38";
    exec = ''
      # Make sure any tools are not attempting to use the python interpreter from any
      # existing virtual environment. For instance if devenv was started within an venv.
      unset VIRTUAL_ENV

      VENV_PATH="$DEVENV_STATE/venv/python38"
      ...
      then
        ...
        ${pkgs.python38}/bin/python -m venv "$VENV_PATH"
